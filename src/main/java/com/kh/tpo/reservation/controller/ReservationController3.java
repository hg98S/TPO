...
//	public String getFlightScheduleSearch(Model model, String sDepAirportNm,String sArrAirportNm ,String sDepPlandTime, int adultCount , int childCount, int infantCount) {
//
...
//		JSONArray aItem2 = new JSONArray();
//		ArrayList<TestFlight> fList = new ArrayList<TestFlight>();
//		ArrayList<TestFlight> fList2 = new ArrayList<TestFlight>();
...
//			urlBuilder.append("&" + URLEncoder.encode("numOfRows","UTF-8") + "=" + URLEncoder.encode("1000", "UTF-8")); /*한 페이지 결과 수*/
//			urlBuilder.append("&" + URLEncoder.encode("pageNo","UTF-8") + "=" + URLEncoder.encode("", "UTF-8")); /*페이지 번호*/
//			urlBuilder.append("&" + URLEncoder.encode("depAirportId","UTF-8") + "=" + URLEncoder.encode(sArrAirportNm, "UTF-8")); /*출발공항ID*/
//			urlBuilder.append("&" + URLEncoder.encode("arrAirportId","UTF-8") + "=" + URLEncoder.encode(sDepAirportNm, "UTF-8")); /*도착공항ID*/
//			//나중에고쳐줘
//			urlBuilder.append("&" + URLEncoder.encode("depPlandTime","UTF-8") + "=" + URLEncoder.encode(sDepPlandTime, "UTF-8")); /*출발일*/
//			urlBuilder.append("&" + URLEncoder.encode("airlineId","UTF-8") + "=" + URLEncoder.encode("", "UTF-8")); /*항공사ID*/
//			urlBuilder.append("&" + URLEncoder.encode("_type","UTF-8") + "=" + URLEncoder.encode("json", "UTF-8")); /*형식*/
...
//			//System.out.println(j_items);
//
//			aItem2 = (JSONArray)jItems.get("item");
//			//System.out.println(aItem);
//
//
//			for(int i = 0; i < aItem.size(); i++)
...
//				flight.setPrestigeCharge((Long)reservationInfo.get("prestigeCharge"));
//				flight.setVihicleId((String)reservationInfo.get("vihicleId"));
//				System.out.println("비행기 하나" + flight);
//				fList2.add(flight);
//			}
//		} catch (Exception e) {
//			e.printStackTrace();
...
//		System.out.println("가는거 : " + fList);
//		System.out.println("오는거 : " + fList2);

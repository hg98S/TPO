            ...
            <div style="width: 50%; float: left;">
              ...
              <script type="text/javascript">
                $("#dAirport").on("change",function(){
                      ...
                      if(airNm == "dAllAirLine" ){
                         $(".dAir").show();
                         console.log($(".dAir").length)
                      }else{
                         $(".dAir").hide();
                         $("."+airNm).show();
                      }
                ...
                <table align="center" class="table table-bordered" style="height: 150px; font-size: 20px;">
                    ...
                    <tbody style="text-align: center;">
                        <tr id="selectGoSchedule">
                            ...
                            <td style="line-height: 2">${flight.airlineNm }&nbsp;${flight.vihicleId }</td>
                            <td style="line-height: 2">${fn:substring(time,0,4) }.${fn:substring(time,4,6) }.${fn:substring(time,6,8) }  ${fn:substring(time,8,10) }:${fn:substring(time,10,12) }</td>
                            <td style="line-height: 2">${fn:substring(time2,0,4) }.${fn:substring(time2,4,6) }.${fn:substring(time2,6,8) }  ${fn:substring(time2,8,10) } : ${fn:substring(time2,10,12) }</td>
                            <td style="line-height: 2">일반석</td>
                            <td style="line-height: 2">38900원</td>
                            <td style="line-height: 2">${adultChildCount }석</td>
                        </tr>
                        <tr id="selectComeSchedule">
                            <td style="line-height: 2">${fList2[0].depAirportNm } -> ${fList2[0].arrAirportNm }</td>
                            <td style="line-height: 2"></td>
                            <%-- <td style="line-height: 2">${fn:substring(time3,0,4) }.${fn:substring(time3,4,6) }.${fn:substring(time3,6,8) }  ${fn:substring(time3,8,10) }:${fn:substring(time3,10,12) }</td> --%>
                            <td style="line-height: 2"></td>
                            <%-- <td style="line-height: 2">${fn:substring(time4,0,4) }.${fn:substring(time4,4,6) }.${fn:substring(time4,6,8) }  ${fn:substring(time4,8,10) }: ${fn:substring(time4,10,12) }</td> --%>
                            <td style="line-height: 2"></td>
                            <td style="line-height: 2"></td>
                            <td style="line-height: 2"></td>
                            <td style="line-height: 2">${adultChildCount }석</td>

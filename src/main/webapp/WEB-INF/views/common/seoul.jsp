...
<body>
	<svg style="overflow: visible; height:656; width:800; margin-top:50px; margin-left:50px;"
							...
							<text id="LCD11" class="cityNum" x="396" y="415" fill="#000000"><a></a></text>
							
							<text id="LCD11200" class="CITYTEXT" x="505" y="356"><a href="#">성동구</a></text>
							<text id="LCD11" class="cityNum" x="494" y="376" fill="#000000"><a></a></text>
							
							<text id="LCD11215" class="CITYTEXT" x="577" y="365"><a href="#">광진구</a></text>
							<text id="LCD11" class="cityNum" x="566" y="385" fill="#000000"><a></a></text>
							
							<text id="LCD11230" class="CITYTEXT" x="528" y="294"><a href="#">동대문</a></text>
							<text id="LCD11" class="cityNum" x="517" y="314" fill="#000000"><a></a></text>
							
							<text id="LCD11260" class="CITYTEXT" x="589" y="270"><a href="#">중랑구</a></text>
							<text id="LCD11" class="cityNum" x="578" y="290" fill="#000000"><a></a></text>
							
							<text id="LCD11290" class="CITYTEXT" x="466" y="258"><a href="#">성북구</a></text>
							<text id="LCD11" class="cityNum" x="455" y="278" fill="#000000"><a></a></text>
							
							<text id="LCD11305" class="CITYTEXT" x="459" y="181"><a href="#">강북구</a></text>
							<text id="LCD11" class="cityNum" x="448" y="201" fill="#000000"><a></a></text>
							
							<text id="LCD11320" class="CITYTEXT" x="494" y="125"><a href="#">도봉구</a></text>
							<text id="LCD11" class="cityNum" x="483" y="145" fill="#000000"><a></a></text>
							
							<text id="LCD11350" class="CITYTEXT" x="560" y="153"><a href="#">노원구</a></text>
							<text id="LCD11" class="cityNum" x="549" y="173" fill="#000000"><a></a></text>
							
							<text id="LCD11380" class="CITYTEXT" x="323" y="218"><a href="#">은평구</a></text>
							<text id="LCD11" class="cityNum" x="312" y="238" fill="#ffffff"><a></a></text>
							
							<text id="LCD11410" class="CITYTEXT" x="342" y="302"><a href="#">서대문</a></text>
							<text id="LCD11" class="cityNum" x="331" y="322" fill="#ffffff"><a></a></text>
							
							<text id="LCD11440" class="CITYTEXT" x="293" y="339"><a href="#">마포구</a></text>
							<text id="LCD11" class="cityNum" x="282" y="359" fill="#ffffff"><a></a></text>
							
							<text id="LCD11470" class="CITYTEXT" x="209" y="415"><a href="#">양천구</a></text>
							<text id="LCD11" class="cityNum" x="198" y="435" fill="#ffffff"><a></a></text>
							
							<text id="LCD11500" class="CITYTEXT" x="156" y="334"><a href="#">강서구</a></text>
							<text id="LCD11" class="cityNum" x="145" y="354" fill="#ffffff"><a></a></text>
							
							<text id="LCD11530" class="CITYTEXT" x="179" y="470"><a href="#">구로구</a></text>
							<text id="LCD11" class="cityNum" x="168" y="490" fill="#ffffff"><a></a></text>
							
							<text id="LCD11545" class="CITYTEXT" x="279" y="537"><a href="#">금천구</a></text>
							<text id="LCD11" class="cityNum" x="268" y="557" fill="#ffffff"><a></a></text>
							
							<text id="LCD11560" class="CITYTEXT" x="295" y="413"><a href="#">영등포</a></text>
							<text id="LCD11" class="cityNum" x="284" y="433" fill="#ffffff"><a></a></text>
							
							<text id="LCD11590" class="CITYTEXT" x="361" y="451"><a href="#">동작구</a></text>
							<text id="LCD11" class="cityNum" x="350" y="471" fill="#ffffff"><a></a></text>
							
							<text id="LCD11620" class="CITYTEXT" x="353" y="529"><a href="#">관악구</a></text>
							<text id="LCD11" class="cityNum" x="342" y="549" fill="#ffffff"><a></a></text>
							
							<text id="LCD11650" class="CITYTEXT" x="471" y="505"><a href="#">서초구</a></text>
							<text id="LCD11" class="cityNum" x="460" y="525" fill="#ffffff"><a></a></text>
							
							<text id="LCD11680" class="CITYTEXT" x="522" y="464"><a href="#">강남구</a></text>
							<text id="LCD11" class="cityNum" x="511" y="484" fill="#ffffff"><a></a></text>
							
							<text id="LCD11710" class="CITYTEXT" x="624" y="448"><a href="#">송파구</a></text>
							<text id="LCD11" class="cityNum" x="613" y="468" fill="#ffffff"><a></a></text>
							
							<text id="LCD11740" class="CITYTEXT" x="675" y="358"><a href="#">강동구</a></text>
							<text id="LCD11" class="cityNum" x="664" y="378" fill="#ffffff"><a></a></text>
							</g>
							</svg>
</body>
</html>